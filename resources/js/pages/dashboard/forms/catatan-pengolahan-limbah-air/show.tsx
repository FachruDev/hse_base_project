...
export default function CatatanPengolahanLimbahAirShowPage() {
    const { auth, entryForm, flash, name } = usePage<ShowPageProps>().props;
    ...
    return (
        <>
            <Head title={`Detail IPAL ${entryForm.entry.tanggal}`} />
            <DashboardShell
                appName={name}
