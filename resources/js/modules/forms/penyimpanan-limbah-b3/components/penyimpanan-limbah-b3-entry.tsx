...
export function PenyimpananLimbahB3Entry({
    ...
    entryForm,
    userId,
}: PenyimpananLimbahB3EntryProps) {
    const [wasteTypeSelection, setWasteTypeSelection] =
    ...
    const form = useForm<B3FormState>({
        ...
        initiator_user_name: entryForm.entry.operator.name,
        weight_kg: '',
        document_number: '',
        photo: null,
        note: '',
    ...
    return (
        <div className="min-h-screen bg-muted px-4 py-6 lg:px-6 lg:py-8 dark:bg-background">
            <div className="mx-auto flex max-w-5xl flex-col gap-6">
                ...
                <Card className="border-none shadow-sm ring-1 ring-border/60">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Operator: {entryForm.entry.operator.name} (
                            {entryForm.entry.operator.external_id})
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            <FieldGroup className="grid gap-4 md:grid-cols-2">
                                ...
                                <Field>
                                    <FieldLabel htmlFor="movement_time">
                                        Jam
                                    </FieldLabel>
                                    <FieldContent>
                                        <Input
                                ...
                                <Field>
                                    ...
                                    <FieldContent>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                {entryForm.options.movement_types.map(
                                                    (item) => (
                                                        <SelectItem
                                                            key={String(
                                                                item.value,
                                ...
                                <Field>
                                    <FieldLabel htmlFor="waste_type_id">
                                        Jenis Limbah
                                    </FieldLabel>
                                    <FieldContent>
                                        <Select
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                {entryForm.options.waste_types.map(
                                                    (item) => (
                                                        <SelectItem
                                                            key={String(
                                                                item.value,
                                ...
                                {wasteTypeSelection === 'OTHER' ? (
                                    <Field>
                                        <FieldLabel htmlFor="waste_type_other">
                                ...
                                <Field>
                                    <FieldLabel htmlFor="initiator_department_id">
                                        Dept Inisiator
                                    </FieldLabel>
                                    <FieldContent>
                                        <Select
